...
set title 'Energy gaps in YBCO-Hucker, with V = 2.0eV'
...
plot 'Output/plotdata/YaBaCuO-Hucker/avgEnergyGap.dat' u 1:2 notitle w l ls 2,\
'< join Output/plotdata/YaBaCuO-Hucker/avgEnergyGap.dat Output/plotdata/YaBaCuO-Hucker/varEnergyGap.dat' u 1:2:3 title "〈 ΔE 〉"  w yerr ls 2, \
		'Output/plotdata/YaBaCuO-Hucker/topEnergyGap.dat'	u 1:2  title "top ΔE" w lp ls 1 ,\
		'Output/plotdata/YaBaCuO-Hucker/bottomEnergyGap.dat'	u 1:2 title "bottom ΔE" w lp ls 1