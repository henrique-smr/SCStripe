...
set title 'Energy gaps in LBCO-Hucker, with V = 2.0eV'
...
plot 'Output/plotdata/LaBaCuO-Hucker/avgEnergyGap.dat' u 1:2 notitle w l ls 2,\
'< join Output/plotdata/LaBaCuO-Hucker/avgEnergyGap.dat Output/plotdata/LaBaCuO-Hucker/varEnergyGap.dat' u 1:2:3 title "〈 ΔE 〉"  w yerr ls 2, \
		'Output/plotdata/LaBaCuO-Hucker/topEnergyGap.dat'	u 1:2  title "top ΔE" w lp ls 1 ,\
		'Output/plotdata/LaBaCuO-Hucker/bottomEnergyGap.dat'	u 1:2 title "bottom ΔE" w lp ls 1